...
class PaginatedNIDMResultsList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NIDMResults']:
                        return NIDMResults
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['NIDMResults'], typing.List['NIDMResults']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'NIDMResults':
