...
from neurovault_sdk import rest
from neurovault_sdk.configuration import Configuration
from neurovault_sdk.exceptions import ApiTypeError, ApiValueError
from neurovault_sdk.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/2022.10.03/python'
