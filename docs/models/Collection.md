# neurovault_sdk.model.collection.Collection
...
**number_of_images** | decimal.Decimal, int,  | decimal.Decimal,  |  | 
**owner_name** | str,  | str,  |  | 
...
**url** | str,  | str,  |  | 
**doi_add_date** | None, str, datetime,  | NoneClass, str,  |  | value must conform to RFC-3339 date-time
